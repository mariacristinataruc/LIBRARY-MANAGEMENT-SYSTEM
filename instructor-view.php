...
<body>
    ...
    <div class="whole-main">
        ...
        <input type="text" name="id" value="<?php echo $row['inst_ID']; ?>" readonly>
        </div>

        <div class="input">
        <span>FIRST NAME :<span>
        <input type="text" name="fname" value="<?php echo $row['inst_fname']; ?>" readonly>
        </div>
        
        <div class="input">
        <span>LAST NAME :<span>
        <input type="text" name="lname" value="<?php echo $row['inst_lname']; ?>" readonly>
        </div>

        <div class="input">
        <span>DEPARTMENT :<span>
        <input type="text" name="dept" value="<?php echo $row['inst_dept']; ?>"readonly>
        </div>

        <div class="input">
        <span>EMAIL :<span>
        <input type="email" name="email" value="<?php echo $row['inst_email']; ?>"readonly>
        </div>

        <div class="input">
        <span>PHONE NUMBER :<span>
        <input type="text" name="pnum" value="<?php echo $row['inst_pnum']; ?>"readonly>
        </div>
