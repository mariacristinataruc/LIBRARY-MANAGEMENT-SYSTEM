...
<body>
    ...
    <div class="whole-main">
        <div class="menu-bar">
            <div class="admin">
                <img src="assets/admin.png" style="height: 70px;width: 70px;">
                <span>Admin</span>
            </div>
        ...
        <div class="input">
        <span>YEAR :<span>
        <input type="number" name="year" value="<?php echo $row['studYear']; ?>"readonly>
        </div>
        ...
        <input type="text" name="staff" value="<?php echo $row['as_name']; ?>"readonly>
        </div>
