...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["id"])) {
    ...
    $sql = "SELECT 
            ...
            LEFT JOIN 
                `user-roles` 
            ON 
                `admin-staff`.ur_ID = `user-roles`.ur_ID 
            WHERE 
                `admin-staff`.as_ID = ?";
        ...
        <div class="main-dash">
            <div class="nav-dash"> 
                <div class="logo">
                    ...
                    <span>View Admin and Staff</span>
                </div>
            </div>
            ...
            <div class="input-new">
                ...
                <div class="field">
                    ...
                    <div class="input">
                        ...
                        <input type="text" name="fname" value="<?php echo htmlspecialchars($row['as_fname']); ?>" readonly>
                    </div>
                    
                    <div class="input">
                        <span>LAST NAME :</span>
                        <input type="text" name="lname" value="<?php echo htmlspecialchars($row['as_lname']); ?>" readonly>
                    </div>

                    <div class="input">
                        <span>EMAIL :</span>
                        <input type="email" name="email" value="<?php echo htmlspecialchars($row['as_email']); ?>" readonly>
                    </div>

                    <div class="input">
                        <span>PHONE NUMBER :</span>
                        <input type="text" name="pnum" value="<?php echo htmlspecialchars($row['as_pnum']); ?>" readonly>
                    </div>
                    
                    <div class="input">
                        <span>USER ROLE DESCRIPTION :</span>
                        <input type="text" name="ur_name" value="<?php echo htmlspecialchars($row['ur_name']); ?>" readonly>
                    </div>
                </div>
            </div>
        </div>
