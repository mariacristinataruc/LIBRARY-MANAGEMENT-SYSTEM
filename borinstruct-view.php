...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["id"])) {
    ...
    $instID = $row['inst_ID'];
    $instSql = "SELECT inst_fname, inst_lname FROM `instructors` WHERE inst_ID='$instID'";
    $instResult = $conn->query($instSql);
    if ($instResult && $instResult->num_rows > 0) {
        $instructorRow = $instResult->fetch_assoc();
        $instructorName = $instructorRow['inst_fname'] . ' ' . $instructorRow['inst_lname'];
    } else {
...
<head>
    ...
    <title>View Borrow-Instrucor</title>
        ...
        <div class="main-dash">
            <div class="nav-dash"> 
                <div class="logo">
                    ...
                    <span>View Borrow by Instructor</span>
                </div>
            </div>
            ...
            <div class="input-new">
                ...
                <div class="field">
                    <div class="input">
                        <span>BORROW-INSTRUCTOR ID :</span>
                        <input type="text" name="id" value="<?php echo $row['binst_ID']; ?>" disabled>
                    </div>
                    ...
                    <div class="input">
                        ...
                        <input type="text" name="instID" value="<?php echo htmlspecialchars($instructorName); ?>" disabled>
                    </div>
                    
                    <div class="input">
                        <span>RETURN DATE :</span>
                        <input type="text" name="retdate" value="<?php echo htmlspecialchars($row['binst_retDate']); ?>" disabled>
                    </div>
                    
                    <div class="input">
                        <span>STATUS :</span>
                        <input type="text" name="state" value="<?php echo htmlspecialchars($row['binst_state']); ?>" disabled>
                    </div>
                    
                    <div class="input">
                        <span>BORROWED DATE :</span>
                        <input type="text" name="bordate" value="<?php echo htmlspecialchars($row['binst_borDate']); ?>" disabled>
                    </div>
                    ...
                    <div class="input">
                        ...
                        <input type="text" name="expdate" value="<?php echo htmlspecialchars($row['binst_expDate']); ?>" disabled>
                    </div>
