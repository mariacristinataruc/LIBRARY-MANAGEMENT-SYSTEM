...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE `students` SET studFname='$fname', studLname='$lname', studCourse='$course', studYear='$year', studEmail='$email', studPnum='$pnum', as_ID='$stname' WHERE stud_ID='$id'";
...
<head>
    ...
    <link rel="shortcut icon" href="assets/stud.png">
    ...
    <div class="whole-main">
        ...
        <div class="main-dash">
            ...
            <div class="input-new">
                ...
                <div class="back-btn">
                    <a href="students.php"><button><img src="assets/back.png"></button></a>
                ...
                <form method="POST" action="">
                    <div class="field">
                        <div class="input">
                            ...
                            <input type="text" name="id" value="<?php echo htmlspecialchars($row['stud_ID']); ?>" readonly>
                        </div>

                        <div class="input">
                            <span>FIRST NAME :<span>
                            <input type="text" name="fname" value="<?php echo htmlspecialchars($row['studFname']); ?>" required>
                        </div>

                        <div class="input">
                            <span>LAST NAME :<span>
                            <input type="text" name="lname" value="<?php echo htmlspecialchars($row['studLname']); ?>" required>
                        </div>

                        <div class="input">
                            <span>COURSE :<span>
                            <input type="text" name="course" value="<?php echo htmlspecialchars($row['studCourse']); ?>" required>
                        </div>

                        <div class="input">
                            <span>YEAR :<span>
                            <input type="text" name="year" value="<?php echo htmlspecialchars($row['studYear']); ?>" required>
                        </div>

                        <div class="input">
                            <span>EMAIL :<span>
                            <input type="email" name="email" value="<?php echo htmlspecialchars($row['studEmail']); ?>" required>
                        </div>

                        <div class="input">
                            <span>PHONE NUMBER :<span>
                            <input type="number" name="pnum" value="<?php echo htmlspecialchars($row['studPnum']); ?>" required>
                        </div>

                        <div class="input">
                            <span>ADMIN/STAFF ID :<span>
                            <input type="text" name="stname" value="<?php echo htmlspecialchars($row['as_ID']); ?>" required>
                        </div>
