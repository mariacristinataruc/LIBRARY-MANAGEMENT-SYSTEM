...
if ($instructorResult->num_rows > 0) {
    while ($row = $instructorResult->fetch_assoc()) {
        $instructorOptions .= "<option value='" . $row['inst_ID'] . "'>" . $row['inst_fname'] . " " . $row['inst_lname'] . " (" . $row['inst_ID'] . ")</option>";
    }
}
...
// Retrieve admin book IDs
$bookResult = $conn->query("SELECT b_ID, b_title FROM `book-info`");
$bookOptions = '';
if ($bookResult->num_rows > 0) {
    while ($row = $bookResult->fetch_assoc()) {
        $bookOptions .= "<option value='" . $row['b_ID'] . "'>" . $row['b_title'] . " (" . $row['b_ID'] . ")</option>";
    }
}
?>
...
<head>
    ...
    <title>New Borrow-Instructor</title>
...
<body>
    ...
    <div class="whole-main">
        <div class="menu-bar">
            ...
            <div class="logout">
                <a href="logout" style="font-size: 20px;"><img src="assets/logout.png" style="height:40px; width: 40px; margin:630px 0 0 15px;"></a>
            </div>
        </div>
        ...
        <div class="main-dash">
            <div class="nav-dash"> 
                <div class="logo">
                    ...
                    <span>New Borrow by Instructor</span>
                </div>
            </div>
            ...
            <div class="input-new">
                ...
                <div class="back-btn">
                    <a href="bor-instructs.php"><button><img src="assets/back.png"></button></a>
                ...
                <form action="bor-instructs.php" method="POST">
                <div class="field">
            ...
            <select name="bookID" required>
                ...
                // Fetch instructor IDs from instructors table
                ...
                ?>
                    ...
                    <div class="input"><span style="font-weight:700;color: #1A4D2E;text-shadow: 0 2px 4px #F5EFE6;"> BORROWED DATE :</span>
                        <input type="date" placeholder="borrowed date" name="bordate" style="font-size: x-large;" required> 
                    </div>

                    <div class="input">
            <!-- Dropdown for Instructor ID -->
            <span style="font-weight:700;color: #1A4D2E;text-shadow: 0 2px 3px #F5EFE6;">INSTRUCTOR ID :</span>  
            <select name="instID" required>
                ...
                // Fetch instructor IDs from instructors table
                $sql = "SELECT inst_ID, CONCAT(inst_fname, ' ', inst_lname) AS full_name FROM `instructors`";
                $result = $conn->query($sql);

                // Populate dropdown options
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<option value='" . $row['inst_ID'] . "'>" . $row['full_name'] . " (" . $row['inst_ID'] . ")</option>";
                    }
                }
                ...
                ?>
                    ...
                    <div class="input"><span style="font-weight:700;color: #1A4D2E;text-shadow: 0 2px 4px #F5EFE6;">RETURN DATE :</span>  
                        <input type="date" placeholder="return date" name="retdate" style="font-size: x-large;" required> 
                    </div>

                    <div class="input">
            <!-- Dropdown for admin staff ID -->
        ...
        <div class="input"><span style="font-weight:700;color: #1A4D2E;text-shadow: 0 2px 3px #F5EFE6;">EXPECTED DATE :</span>  
