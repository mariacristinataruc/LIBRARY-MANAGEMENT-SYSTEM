...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["id"])) {
    ...
    $sql = "SELECT * FROM `book-info` WHERE b_ID='$id'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE `book-info` SET b_title='$title', b_desc='$desc', author='$author', b_pubDate='$pubdate', b_acqDate='$acqdate' WHERE b_ID='$id'";
        ...
        <div class="main-dash">
            ...
            <div class="input-new">
                ...
                <form method="POST" action="">
                    <div class="field">
                        <div class="input">
                            <span>BOOK ID :(read only)<span>
                            <input type="text" name="id" value="<?php echo htmlspecialchars($row['b_ID']); ?>" readonly>
                        </div>

                        <div class="input">
                            <span>TITLE :<span>
                            <input type="text" name="title" value="<?php echo htmlspecialchars($row['b_title']); ?>" required>
                        </div>

                        <div class="input">
                            <span>DESCRIPTION :<span>
                            <input type="text" name="desc" value="<?php echo htmlspecialchars($row['b_desc']); ?>" required>
                        </div>
                        ...
                        <div class="input">
                            ...
                            <input type="date" name="pubdate" style="font-size: x-large;" value="<?php echo htmlspecialchars($row['b_pubDate']); ?>" required>
                        </div>

                        <div class="input">
                            <span> ACQUISITION DATE :<span>
                            <input type="date" name="acqdate" style="font-size: x-large;" value="<?php echo htmlspecialchars($row['b_acqDate']); ?>" required>
                        </div>
                    </div>
                    <div class="add-new">
