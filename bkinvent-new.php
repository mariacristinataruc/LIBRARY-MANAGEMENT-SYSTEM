...
<head>
    ...
    <link rel="shortcut icon" href="assets/ready-stock.png">
</head>
<style>
    /*import Google Font*/
    ...
    <div class="whole-main">
        ...
        <div class="main-dash">
            ...
            <div class="input-new">
                ...
                <div class="back-btn">
                    <a href="book-invent.php"><button><img src="assets/back.png"></button></a>
                ...
                <form action="book-invent.php" method="POST">
            ...
            <select name="bookID" required>
                ...
                ?>
                    ...
                    <div class="input">
                    <span style="font-weight:700;color: #1A4D2E;text-shadow: 0 2px 3px #F5EFE6;">TOTAL BOOKS :</span>  
                        <input type="number" placeholder="input number" name="totB" required> 
                    </div>

                    <div class="input">
                    <span style="font-weight:700;color: #1A4D2E;text-shadow: 0 2px 3px #F5EFE6;">AVAILABLE BOOKS :</span>  
                        <input type="number" placeholder="input number" name="availB" required> 
                    </div>
                    
                    <div class="input">
                    <span style="font-weight:700;color: #1A4D2E;text-shadow: 0 2px 3px #F5EFE6;">BORROWED BOOKS :</span>  
                        <input type="number" placeholder="input number" name="borB" required> 
                    </div>

                    <div class="input">
                    <span style="font-weight:700;color: #1A4D2E;text-shadow: 0 2px 3px #F5EFE6;">RETURN BOOKS :</span>  
                        <input type="number" placeholder="input number" name="retB" required> 
                    </div>
