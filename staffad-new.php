...
.input input {
        ...
        border-radius: 10px;
        border: none;
        padding-left: 10px; /* Adjust padding to your preference */
        text-align: left; /* You can remove this line */
}
        ...
        <div class="main-dash">
            <div class="nav-dash"> 
                <div class="logo">
                    ...
                    <span>Add New Staff and Admin</span>
                </div>
            </div>
            <div class="input-new">
                <div class="back-btn">
                ...
                <form action="staff-admin.php" method="POST">
                    <div class="field">
                        <div class="input">
                            <span>USERNAME :</span>
                        ...
                        <span>PHONE NUMBER :</span>
                            <input type="number" placeholder="phone number" name="pnum" maxlength="11" pattern="\d{1,11}" required> 
                        </div>                        
                    </div>
                    <div class="add-new">
