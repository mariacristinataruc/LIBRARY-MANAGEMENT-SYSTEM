...
<head>
    ...
    <title>View Books Inventory</title>
...
<body>
    ...
    <div class="whole-main">
        ...
        <div class="main-dash">
            <div class="nav-dash"> 
                <div class="logo">
                    ...
                    <span>View Books Inventory</span>
                </div>
            </div>
        ...
        <div class="input">
            <span>BOOK-INVENTORY ID :</span>
            <input type="text" name="id" value="<?php echo $row['bnv_ID']; ?>" disabled>
        </div>
        ...
        <div class="input">
            ...
            <input type="number" name="totB" value="<?php echo $row['bnv_totB']; ?>" disabled>
        </div>

        <div class="input">
            <span>AVAILABLE BOOKS :</span>
            <input type="number" name="availB" value="<?php echo $row['bnv_availB']; ?>" disabled>
        </div>

        <div class="input">
            <span>BORROWED BOOKS :</span>
            <input type="number" name="borB" value="<?php echo $row['bnv_borB']; ?>" disabled>
        </div>

        <div class="input">
            <span>RETURNED BOOKS :</span>
            <input type="number" name="retB" value="<?php echo $row['bnv_retB']; ?>" disabled>
        </div>
