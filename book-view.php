...
<body>
    ...
    <div class="whole-main">
        ...
        <div class="input">
        <span>BOOK ID :<span>
        <input type="text" name="id" value="<?php echo $row['b_ID']; ?>" readonly>
        </div>

        <div class="input">
        <span>TITLE :<span>
        <input type="text" name="title" value="<?php echo $row['b_title']; ?>" readonly>
        </div>
        
        <div class="input">
        <span>DESCRIPTION :<span>
        <input type="text" name="desc" value="<?php echo $row['b_desc']; ?>" readonly>
        </div>

        <div class="input">
        <span>AUTHOR ID :<span>
        <input type="text" name="author" value="<?php echo $row['author']; ?>"readonly>
        </div>

        <div class="input">
        <span>PUBLICATION DATE :<span>
        <input type="date" name="pubdate" style="font-size: x-large;" value="<?php echo $row['b_pubDate']; ?>"readonly>
        </div>

        <div class="input">
        <span>ACQUISITION DATE :<span>
        <input type="date" name="acqdate" style="font-size: x-large;" value="<?php echo $row['b_acqDate']; ?>"readonly>
        </div>
