...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["id"])) {
    ...
    // Retrieve students IDs and names
    $studentResult = $conn->query("SELECT stud_ID, studFname, studLname FROM `students`");
    $studentOptions = '';
    if ($studentResult->num_rows > 0) {
        while ($studentRow = $studentResult->fetch_assoc()) {
            $selected = ($row['stud_ID'] == $studentRow['stud_ID']) ? 'selected' : '';
            $studentOptions .= "<option value='" . htmlspecialchars($studentRow['stud_ID']) . "' $selected>" . htmlspecialchars($studentRow['studFname']) . " " . htmlspecialchars($studentRow['studLname']) . " (" . htmlspecialchars($studentRow['stud_ID']) . ")</option>";
        }
    }
...
<head>
    ...
    <title>Update Borrow-Student</title>
        ...
        <div class="main-dash">
            <div class="nav-dash"> 
                <div class="logo">
                    ...
                    <span>Update Borrow by Student</span>
                </div>
            </div>
            ...
            <div class="input-new">
                ...
                <form method="POST" action="">
                    <div class="field">
                        <div class="input">
                            <span>BOOK-STUDENT ID :(read only)<span>
                            <input style="color:gray;" type="text" name="id" value="<?php echo htmlspecialchars($row['bs_ID']); ?>" readonly>
                        </div>
                        ...
                        <div class="input">
                            ...
                            <input type="date" name="bordate" style="font-size: x-large;" value="<?php echo htmlspecialchars($row['bs_borDate']); ?>" required>
                        </div>
                        
                        <div class="input">
                            <span>STATUS :<span>
                            <input type="text" name="state" value="<?php echo htmlspecialchars($row['bs_state']); ?>" required>
                        </div>

                        <div class="input">
                            <span> RETURN DATE :<span>
                            <input type="date" name="retdate" style="font-size: x-large;" value="<?php echo htmlspecialchars($row['bs_retDate']); ?>" required>
                        </div>
                        
                        <div class="input">
                            <label for="instID">STUDENT ID:</label><br>
                            <select name="studID" id="studID" required>
                        ...
                        <div class="input">
                            ...
                            <input type="date" name="expdate" style="font-size: x-large;" value="<?php echo htmlspecialchars($row['bs_expDate']); ?>" required>
                        </div>
